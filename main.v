...
module main (
 ...
 clock_reset divisor_clock (
   ...
   // Paridade do pixel fisico atual dentro do par duplicado horizontalmente:
   // usada pelo motor_background para compensar corretamente a latencia do
   // seu pipeline de memoria (ver comentario em motor_background.v).
   wire paridade_x_fisica = coord_x_vga[0];
